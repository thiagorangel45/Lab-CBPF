...
void muonVel() {
    ...
    graph->SetLineColor(1); // Cor preta
    graph->SetLineWidth(2); // Largura da linha
    graph->SetLineStyle(1); // Estilo da linha
    graph->SetMarkerColor(0); // Cor do marcador
    graph->SetMarkerStyle(0); // Estilo do marcador
    graph->SetMarkerSize(0); // Tamanho do marcador
